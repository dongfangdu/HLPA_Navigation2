...
def create_layout():
    st.sidebar.title("菜单")
    app_mode = st.sidebar.selectbox("请选择其中一个功能", ["首页", "推荐", "接口文档"])
    if app_mode == '首页':
        homepage()
    elif app_mode == '推荐':
        recommend()
